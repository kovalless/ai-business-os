...
import { Actuator, Field, Label, Row, Sill, Toggle, Token, Whisper } from "@/components/ui";
import { business } from "@/lib/data";

const SOURCES = [
  { id: "bunq", name: "Bunq", detail: "Business account \u00B7 synced 06:40", ok: true },
  { id: "ing", name: "ING", detail: "Savings \u00B7 synced 06:40", ok: true },
  { id: "stripe", name: "Stripe", detail: "Card payments \u00B7 synced 09:12", ok: true },
  { id: "moneybird", name: "Moneybird", detail: "Invoices \u00B7 synced 09:12", ok: true },
  { id: "square", name: "Square", detail: "Expired 12 June", ok: false },
];
    ...
    >
      ...
      <section>
        ...
        <div className="mt-rise flex flex-col gap-stride">
          ...
          <Field label="Standing figure" value="Cash on hand" readOnly />
          <Whisper>
