...
import { marginNote, moves, signals, standing, statement, supporting } from "@/lib/data";
...
export default function TodayPage() {
  ...
  return (
    <Room
      title="Today"
      meta="Tuesday, 29 July"
      margin={
        <>
          <MarginNote
            text={marginNote.text}
            confidence={marginNote.confidence}
            actions={marginNote.actions}
          />
